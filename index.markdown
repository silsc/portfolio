...
<div class="banner">
    ...
    <div class="banner-subtitle">
      <h2>(</h2>
        <p>I’m a UX / Front end web developer based <br>in Tokyo, Japan 🇯🇵</p>
      <h2>)</h2>
    </div>
...
<div id="aboutme" class="section">
  <div class="aboutme-container">
    <div class="aboutme-card">
      <h1>About me</h1>
      <img src="/assets/images/underline.svg" class="underline-aboutme"/>
...
<div id="work" class="section">
  <div class="work-container">
    <img src="/assets/images/work-arrow.svg" class="work-arrow"/>
    <div class="work-header">
      <h1>Let me show you</h1>
      <h1 class="work-header-line2">some of my favourite works.</h1>
      <img src="/assets/images/work-circle.svg" class="work-circle"/>
    </div>
